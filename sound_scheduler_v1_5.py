...
class SchedulerApp(QWidget):
    ...
    def init_ui(self):
        ...
        # Lägga till logotypen längst ner och skala den
        self.logo_label = QLabel(self)
        pixmap = QPixmap("Eyra temp logo 6.png")  # Ladda bilden
        self.logo_label.setPixmap(pixmap)

        # Ställ in storlek på loggan så den passar rutan utan att ändra fönstrets storlek
        self.logo_label.setFixedSize(200, 150)  # Anpassa storleken här
    ...
    def get_combined_schedule(self):
        """Returnera texten från rutan 'Sammanlagt schema med pauser'."""
